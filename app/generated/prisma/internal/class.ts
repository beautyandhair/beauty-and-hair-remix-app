...
/**
  ...
  /**
   * `prisma.vendorColorGroup`: Exposes CRUD operations for the **VendorColorGroup** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more VendorColorGroups
    * const vendorColorGroups = await prisma.vendorColorGroup.findMany()
    * ```
    */
  get vendorColorGroup(): Prisma.VendorColorGroupDelegate<ExtArgs, ClientOptions>;
}
