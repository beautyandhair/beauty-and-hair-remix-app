...
export type FunctionRunResult = {
  /** The list of displayable errors. */
  displayableErrors?: InputMaybe<Array<DisplayableError>>;
  /** The list of applied line discounts. */
...
export type Input = {
  ...
  /** The cart. */
  cart: Cart;
  /** The list of discounts to be allocated. */
...
export type RunInput = { __typename?: 'Input', discounts?: Array<{ __typename?: 'Discount', id: string, title: string, code?: string | null, discountApplicationStrategy: DiscountApplicationStrategy, discountProposals: Array<{ __typename?: 'DiscountProposal', handle: any, message?: string | null, value: { __typename: 'FixedAmount', amount: any, appliesToEachItem: boolean } | { __typename: 'Percentage', value: any }, targets: Array<{ __typename?: 'CartLineTarget', cartLineId: string, quantity: number }> }> }> | null, cart: { __typename?: 'Cart', lines: Array<{ __typename?: 'CartLine', id: string, quantity: number, cost: { __typename?: 'CartLineCost', amountPerQuantity: { __typename?: 'MoneyV2', amount: any } }, merchandise: { __typename: 'CustomProduct' } | { __typename: 'ProductVariant', id: string, metafield?: { __typename?: 'Metafield', value: string } | null } }> } };
